...
function SignUpForm() {
  ...
  const handleSubmit = (e) => {
    ...
    // Uncomment the following line if you are using router for redirection
    ...
    <div style={{ 
      ...
      >
        ...
        <p style={{ marginTop: '10px', textAlign: 'center', color: '#666' }}>
          Already have an account? <Link href="/login" style={{ color: '#800000', textDecoration: 'underline' }}>Login</Link>
        </p>
      </form>
    </div>
  );
